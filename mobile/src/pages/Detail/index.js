...
export default function Detail(){
    ...
    const message = `Olá, ${incident.name}. \n\nEstou entrando em contato pois gostaria de ajudar com o caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', {
        style:'currency',
        currency: 'BRL'
    ...
    function sendWhatsapp(){
        const toPhoneNumber = incident.whatsapp;
